...
public class Metrics {
    ...
    private JsonObject getServerData() {
        ...
        data.addProperty("玩家数量", playerAmount);
        data.addProperty("在线模式", onlineMode);
        data.addProperty("bukkit版本", bukkitVersion);
        data.addProperty("bukkit名称", bukkitName);

        data.addProperty("java版本", javaVersion);
        data.addProperty("操作系统名称", osName);
        data.addProperty("操作系统架构", osArch);
        data.addProperty("操作系统版本", osVersion);
        data.addProperty("核心数量", coreCount);
